...
# =============================================================================
# Step 3 - Flattening
classifier.add(Flatten(input_shape = (75, 75, 3)))

# Step 4 - Full connection
#classifier.add(Dense(units = 128, input_shape = (75, 75, 3), activation = 'relu'))
...
# 
# =============================================================================
test_set = train_datagen.flow(x = x_test, y = y_test , batch_size=32)
